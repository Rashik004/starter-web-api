...
Use template from `F:/PromineoRepo/MPP/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `F:/PromineoRepo/MPP/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "F:/PromineoRepo/MPP/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
