...
Reference full template: `F:/PromineoRepo/MPP/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `F:/PromineoRepo/MPP/.claude/get-shit-done/templates/state.md`.
