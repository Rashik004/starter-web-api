...
See F:/PromineoRepo/MPP/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using F:/PromineoRepo/MPP/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using F:/PromineoRepo/MPP/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from F:/PromineoRepo/MPP/.claude/get-shit-done/templates/discovery.md
...
Use F:/PromineoRepo/MPP/.claude/get-shit-done/templates/discovery.md.
