...
<required_reading>
@F:/PromineoRepo/MPP/.claude/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "F:/PromineoRepo/MPP/.claude/get-shit-done/bin/gsd-tools.cjs" init resume)
