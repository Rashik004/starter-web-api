...
<!-- For checkpoint task examples and patterns, see @F:/PromineoRepo/MPP/.claude/get-shit-done/references/checkpoints.md -->
...
See `F:/PromineoRepo/MPP/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `F:/PromineoRepo/MPP/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `F:/PromineoRepo/MPP/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
